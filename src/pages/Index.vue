          ...
          <div class="text-lg sm:text-lg mb-16">
            <form 
              ...
              <div class="w-full mb-12">
                  ...
                  <textarea id="songs" rows="5" name="songs" class="block w-full bg-background-form border border-border-color-primary shadow rounded outline-none appearance-none focus:border-orange-700 mb-2 px-4 py-4" placeholder="Please let us know your favourite song, what would you love the DJ to play on the night?" 
              ...
              <div class="w-full mb-12">
                  ...
                  <textarea id="dietary" rows="5" name="dietary" class="block w-full bg-background-form border border-border-color-primary shadow rounded outline-none appearance-none focus:border-orange-700 mb-2 px-4 py-4" placeholder="Please let us know if you have any special dietary requirements." 
              ...
              <div class="w-full mb-12">
                  ...
                  <textarea id="message" rows="5" name="message" class="block w-full bg-background-form border border-border-color-primary shadow rounded outline-none appearance-none focus:border-orange-700 mb-2 px-4 py-4" placeholder="Please let us know the names of your own guests, such as your own children etc" 
