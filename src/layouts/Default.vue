<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-orange-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#events" v-scroll-to="'#events'" class="text-copy-primary hover:text-gray-600">Events</a>
            <g-link v-else to="/#events" class="text-copy-primary hover:text-gray-600">Events</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
    ...
    <footer class="bg-orange-700 text-white">
